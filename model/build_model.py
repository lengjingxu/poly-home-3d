...
ROOM_POLYGONS = {
    "主卧": [
        (1.90, 0.02), (6.00, 0.02), (6.00, 3.45), (5.00, 3.45),
        (5.00, 3.85), (1.90, 3.85),
    ],
    "衣帽间": [(6.00, 1.90), (8.55, 1.90), (8.55, 4.45), (6.00, 4.45)],
    "卫生间": [(6.10, 4.60), (8.55, 4.60), (8.55, 6.20), (6.10, 6.20)],
    "走廊": [(4.70, 4.35), (6.00, 4.35), (6.00, 6.45), (4.70, 6.45)],
    "次卧": [(1.75, 3.90), (4.35, 3.90), (4.70, 4.35), (4.70, 6.45),
             (1.75, 6.45)],
    "客餐厨": [(1.75, 6.65), (5.05, 6.65), (5.05, 7.25), (8.55, 7.05),
               (8.55, 9.90), (10.95, 9.90), (10.95, 11.05), (11.10, 11.05),
...
OUTER_WALL = [
    (1.90, 0.00), (6.00, 0.00), (6.00, 1.90), (8.55, 1.90), (8.55, 4.60),
    (8.55, 6.20), (8.55, 7.05), (8.55, 9.90), (10.95, 9.90),
    ...
    (0.05, 8.45), (0.65, 8.80), (1.75, 9.35), (1.75, 6.45), (1.75, 3.90),
    (1.90, 3.85),
]

INTERIOR_WALLS = [
    ((1.90, 3.45), (5.00, 3.45), [(1.55, 2.35)]),
    ((1.75, 3.90), (4.35, 3.90), [(1.55, 2.35)]),
    ((4.70, 4.35), (4.70, 6.45), [(0.25, 1.05)]),
    ((1.75, 6.45), (4.70, 6.45), [(2.10, 2.95)]),
    ((5.00, 3.45), (5.00, 4.35), [(0.18, 0.88)]),
    ((6.00, 1.90), (6.00, 4.45), [(0.80, 1.60)]),
    ((6.00, 4.45), (8.55, 4.45), [(0.80, 1.60)]),
    ((6.10, 4.60), (6.10, 6.20), [(0.35, 1.10)]),
    ((4.70, 6.45), (6.00, 6.45), [(0.25, 0.95)]),
]

WINDOWS = [
    ((2.15, 0.02), (5.70, 0.02), 0.15, 3.20),
    ((8.55, 2.05), (8.55, 4.25), 0.15, 2.05),
...
def build_door_frames(m: Model) -> None:
    """门洞两侧的竖向门套。"""
    jambs = [
        (3.45, 3.45, 0), (4.25, 3.45, 0),
        (4.70, 4.60, math.pi / 2), (4.70, 5.40, math.pi / 2),
        (3.75, 6.45, 0), (4.57, 6.45, 0),
        (6.00, 2.70, math.pi / 2), (6.00, 3.50, math.pi / 2),
        (6.80, 4.45, 0), (7.60, 4.45, 0),
        (6.10, 4.95, math.pi / 2), (6.10, 5.75, math.pi / 2),
    ]
...
def build_doors(m: Model) -> None:
    """开着的门扇，给剖切模型一点生活感。"""
    leaves = [
        (3.85, 3.45, 0.82, math.pi),
        (4.70, 4.98, 0.82, math.pi / 2),
        (4.16, 6.45, 0.82, math.pi),
        (6.00, 3.10, 0.82, math.pi / 2),
        (7.20, 4.45, 0.82, 0.0),
        (6.10, 5.35, 0.82, math.pi / 2),
    ]
